...
class TakePictureScreenState extends State<TakePictureScreen> {
  ...
  static const platform = const MethodChannel('go/gonative');
  ...
  Future<void> primitive(String path) async {
    String result;
    try {
      var arguments = Map();
      arguments["name"] = path;
      arguments["inters"] = 30;
      arguments["size"] = 100;
      arguments["workers"] = 16;
      arguments["mode"] = 0;

      result =
      await platform.invokeMethod('dataProcessor_primitive', arguments);
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          try {
            ...
            await primitive(path);
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => DisplayPictureScreen(imagePath: path + ".out.png"),
              ),
            );
